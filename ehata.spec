...
URL:		https://github.com/mrdvt92/ehata
#git archive --format=tar.gz -o ehata-3.2.0.0.tar.gz --prefix=ehata-3.2.0.0/ master
Source0:	https://github.com/mrdvt92/ehata/archive/master.tar.gz?prefix=ehata-3.2.0.0;o=./ehata-3.2.0.0.tar.gz
